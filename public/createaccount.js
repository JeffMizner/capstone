...
function CreateMsg(props){
    ...
    return(
        ...
        <a href='#/activity/' data-toggle="tooltip" title="Check Balance and Activity">Check Balance and Activity</a><br/>
        <a href='#/deposit/' data-toggle="tooltip" title="Make a Deposit">Make a Deposit</a><br/>
        <a href='#/withdraw/' data-toggle="tooltip" title="Make a Withdrawal">Make a Withdrawal</a><br/><br/>
        <button 
            type      = "submit" 
...
function CreateForm(props){
    ...
    function handle() { 
        ...
        auth.createUserWithEmailAndPassword(email,password)
            .then((userCredential) => {
                ...
                var createAccountMessage = `Account successfully created for: ${email}`;
            ...
            .then((userCredential) => {
                ...
                (async () => {
                    ...
                    if (responseString == '[]') {
                        ...
                        var createAccountMessage = `Account was successfully created for: ${userCredential.user.email}`;
                        // Setting the account up in the database
    ...
    return(
        <>
        <h4>Create an account below with the following information:</h4><br/>
        Name<br/>
        <input 
            type        = "input"
        ...
        <button
            ...
            className   = "btn btn-dark" 
            onClick     = {loginGoogle}>  
            <img src="/public/glogo.png" alt="Google Logo" height="15em" width="15em"></img>
            &nbsp; Sign in with Google
        </button>
        </>
    )
