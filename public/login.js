...
// NEED TO EXPAND THIS FUNCTIONALITY
...
function LogInMsg(props){
    ...
    return(
        <>
        <h4>Login with your information below:</h4><br/>
        Email Address<br/>
        <input 
            type        = "input"
        ...
        <a href='#/CreateAccount/' data-toggle="tooltip" title="Create an Account">Create Account</a>
        </>
