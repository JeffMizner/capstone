...
function BalanceDisplay(props){
    ...
    var sampleValue = 100;
    var testArray = [<tr><td>SAMPLE{sampleValue}</td><td>SAMPLE</td></tr>,<tr><td>SAMPLE</td></tr>];
    ...
    if(!tablehtml) {
        ...
        (async () => {
            ...
            for (const {date, time, type, amount, balance} of userData[0].activity) {
    ...
    return(
        ...
        <table className="table">
            <thead>
                ...
                <th scope="col">Current Available Balance</th>
                <th scope="col">Account Holder Since</th>
                </tr>
            </thead>
            <tbody>
                <tr>
        ...
        <table className="table">
            <thead>
                <tr>
                <th scope="col" className="text-justify">Date</th>
                <th scope="col" className="text-justify">Time</th>
                <th scope="col" className="text-justify">Type</th>
...
function LoginMsg(props){
    ...
    return(
        <>
        You are currently not logged in. Please sign in before continuing.<br/><br/>
				<a href='#/login/' className="btn btn-dark" data-toggle="tooltip" title="Log in to access your account">Login</a>
                &nbsp;
                or 
                &nbsp;
				<a href="#/createaccount/" className="btn btn-dark" data-toggle="tooltip" title="Create an account to begin using the Money Bin online">Create Account</a>
        </>
    );
}